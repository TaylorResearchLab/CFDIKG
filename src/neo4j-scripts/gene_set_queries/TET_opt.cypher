...
match (a:Code)<-[:CODE]-(mp_concept:Concept)-[]-(hcop_concept:Concept)-[:CODE]->(mouse_gene:Code)
...
with ['MP:0010402','MP:0000273','MP:0000276','MP:0006128'] as phenos
match (a:Code )-[:CODE]-(mp_concept:Concept)-[r3]-(hcop_concept:Concept)-[r4]-(mouse_gene:Code)
...
with *
match (gtex_concept)--(gtex_code:Code)-[:p_value]-(gtex_term:Term)
...
match (human_gene_2:Code)--(b:Concept)-[:has_single_cell_expression]-(c:Concept)--(d:Code)-[:log2fc]-(t:Term) 
