...
- We ingested two datasets from ****[https://gtexportal.org/home/datasets](https://gtexportal.org/home/datasets):**
    ...
    ![Human gene concept  (HGNC code), linked by expression to the GTEX expression value (green term) linked to the tissue (Uberon code)](Data%20Source%20Descriptions%20and%20Schema%20Reference%20b65dd193a91841e6ba34bd6b16f8fc2c/GTEx_expression.png)
...
![From left to right (Concepts are orange): A tissue Concept (could be UBERON, FMA or SNOMED) , HuBMAP dataset Concept, HuBMAP cluster Concept (most datasets have between 10 and 20 clusters), HuBMAP expression Concept and a HGNC Concept.](Data%20Source%20Descriptions%20and%20Schema%20Reference%20b65dd193a91841e6ba34bd6b16f8fc2c/hubmap.png)
...
![HGNC Concept (blue), Code (purple) and Term (green) from HGNC on the left and its corresponding Mouse gene Concept and code on the right  ](Data%20Source%20Descriptions%20and%20Schema%20Reference%20b65dd193a91841e6ba34bd6b16f8fc2c/HGNC_HCOP.png)
...
![A Concept (blue), Code (purple) and Term (green) node from HPO (left side) and HGNC (right side) and the bidirectional relationships between the two Concept nodes.](Data%20Source%20Descriptions%20and%20Schema%20Reference%20b65dd193a91841e6ba34bd6b16f8fc2c/HPO_HGNC.png)
...
![A Concept (blue), Code (purple) and Term (green) from HPO on the left and its corresponding MP Concept, Code and Term on the right.](Data%20Source%20Descriptions%20and%20Schema%20Reference%20b65dd193a91841e6ba34bd6b16f8fc2c/HPO_MP.png)
...
![graph-5.svg](Data%20Source%20Descriptions%20and%20Schema%20Reference%20b65dd193a91841e6ba34bd6b16f8fc2c/graph-5.svg)
...
![graph-3.svg](Data%20Source%20Descriptions%20and%20Schema%20Reference%20b65dd193a91841e6ba34bd6b16f8fc2c/graph-3.svg)
...
- Relationship Name: **positively_correlated_with_chemical_or_drug, positively_correlated_with_gene, negatively_correlated_with_chemical_or_drug, negatively_correlated_with_gene**
    ...
    ![graph-4.svg](Data%20Source%20Descriptions%20and%20Schema%20Reference%20b65dd193a91841e6ba34bd6b16f8fc2c/graph-4.svg)
...
![Untitled](Data%20Source%20Descriptions%20and%20Schema%20Reference%20b65dd193a91841e6ba34bd6b16f8fc2c/Untitled.png)
...
- Tissue where the co-expression is detected is in the SAB of the relationship  “coexpressed_with”
    ...
    ![graph-2.svg](Data%20Source%20Descriptions%20and%20Schema%20Reference%20b65dd193a91841e6ba34bd6b16f8fc2c/graph-2.svg)
...
![graph.svg](Data%20Source%20Descriptions%20and%20Schema%20Reference%20b65dd193a91841e6ba34bd6b16f8fc2c/graph.svg)
